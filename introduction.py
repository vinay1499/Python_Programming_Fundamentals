...
'''
Tip: you should use comment only if it is adding value to your comment.
'''
...
# Variable names must not start with a number, not contain any special 
# characters other than  underscores(_), not contain any spaces.
...
# An important note is that it always returns a str object which will need to be converted to an int 
...
print("Hey "+ user_name +" your age is "+ age + ".")
